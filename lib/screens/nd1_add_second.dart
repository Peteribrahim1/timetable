...
import 'package:timetable/screens/view_nd1_second.dart';
...
class ND1Add_second extends StatefulWidget {
  const ND1Add_second({super.key});

  @override
  State<ND1Add_second> createState() => _ND1Add_secondState();
}

class _ND1Add_secondState extends State<ND1Add_second> {
  ...
  void saveData() async {
    ...
    if (snap2.length < 11) {
      String res = await AuthMethods().saveND1second(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                        builder: (context) => const ViewNd1Second(),
                      ),
                    );
                  },
                  style: ButtonStyle(
