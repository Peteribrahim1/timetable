...
import 'package:timetable/screens/printabledata_hnd1s.dart';

import '../styles/styles.dart';
import '../widgets/day_widget.dart';

class HNd1Timetable_second extends StatefulWidget {
  const HNd1Timetable_second({super.key});

  @override
  State<HNd1Timetable_second> createState() => _HNd1Timetable_secondState();
}

class _HNd1Timetable_secondState extends State<HNd1Timetable_second> {
  String course1 = '';
  String course2 = '';
  String course3 = '';
  String course4 = '';
  ...
  void fetchData() async {
    final snap =
        await FirebaseFirestore.instance.collection('HND1second').get();
            ...
            Center(
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    await printDoc_hnd1s(course1, course2, course3, course4,
