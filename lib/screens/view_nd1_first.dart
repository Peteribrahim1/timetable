...
class ViewNd1First extends StatefulWidget {
  static const routeName = '/view';
  const ViewNd1First({super.key});

  @override
  State<ViewNd1First> createState() => _ViewNd1FirstState();
}

class _ViewNd1FirstState extends State<ViewNd1First> {
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                        builder: (context) => const Nd1Timetable_first(),
                      ),
                    );
                  },
                  style: ButtonStyle(
