...
import 'package:timetable/screens/printabledata_hnd1f.dart';

import '../styles/styles.dart';
import '../widgets/day_widget.dart';

class HNd1Timetable_first extends StatefulWidget {
  const HNd1Timetable_first({super.key});

  @override
  State<HNd1Timetable_first> createState() => _HNd1Timetable_firstState();
}

class _HNd1Timetable_firstState extends State<HNd1Timetable_first> {
  String course1 = '';
  String course2 = '';
  String course3 = '';
  String course4 = '';
            ...
            Center(
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    await printDoc_hnd1f(course1, course2, course3, course4,
