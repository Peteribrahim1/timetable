...
import 'package:timetable/screens/view_hnd1_first.dart';
...
class HND1Add_first extends StatefulWidget {
  const HND1Add_first({super.key});

  @override
  State<HND1Add_first> createState() => _HND1Add_firstState();
}

class _HND1Add_firstState extends State<HND1Add_first> {
  ...
  void saveData() async {
    ...
    if (snap2.length < 11) {
      String res = await AuthMethods().saveHND1first(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text(
          'ADD COURSE/LECTURER HND1 FIRST',
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pushReplacement(
                      MaterialPageRoute(
                        builder: (context) => const ViewHNd1First(),
                      ),
                    );
                  },
                  style: ButtonStyle(
