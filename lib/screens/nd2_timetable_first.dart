...
import 'package:timetable/screens/printabledata_nd2f.dart';

import '../styles/styles.dart';
import '../widgets/day_widget.dart';

class Nd2Timetable_first extends StatefulWidget {
  const Nd2Timetable_first({super.key});

  @override
  State<Nd2Timetable_first> createState() => _Nd2Timetable_firstState();
}

class _Nd2Timetable_firstState extends State<Nd2Timetable_first> {
  String course1 = '';
  String course2 = '';
  String course3 = '';
  String course4 = '';
  ...
  void fetchData() async {
    final snap = await FirebaseFirestore.instance.collection('ND2first').get();
            ...
            Center(
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    await printDoc_nd2f(course1, course2, course3, course4,
