...
import 'package:timetable/screens/printabledata_nd2s.dart';

import '../styles/styles.dart';
import '../widgets/day_widget.dart';

class Nd2Timetable_second extends StatefulWidget {
  const Nd2Timetable_second({super.key});

  @override
  State<Nd2Timetable_second> createState() => _Nd2Timetable_secondState();
}

class _Nd2Timetable_secondState extends State<Nd2Timetable_second> {
  String course1 = '';
  String course2 = '';
  String course3 = '';
  String course4 = '';
      ...
      body: SafeArea(
        ...
        child: Column(
          ...
          children: [
            ...
            const Center(
              child: Text(
                '200L SECOND SEMESTER TIMETABLE',
            ...
            Center(
              child: SizedBox(
                ...
                child: ElevatedButton(
                  onPressed: () async {
                    await printDoc_nd2s(course1, course2, course3, course4,
